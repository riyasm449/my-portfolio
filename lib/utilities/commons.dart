...
class Commons {
  ...
  static Color bgColor = Commons.colorFromHex('#2A0591');
  static Color whiteColor = Commons.colorFromHex('#EDEDEE');
  static Color textColor = Commons.colorFromHex('#184A45');
  ...
  static List<Color> gradientColor = [
    Commons.colorFromHex('#270570'),
    Commons.colorFromHex('#270580'),
    Commons.colorFromHex('#270595'),
  ];
